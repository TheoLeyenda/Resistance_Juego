...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/nivel6_op2.png", AssetType.IMAGE);
		path.set ("assets/images/nivel_6_op1.png", "assets/images/nivel_6_op1.png");
		type.set ("assets/images/nivel_6_op1.png", AssetType.IMAGE);
		path.set ("assets/images/nivel_9.png", "assets/images/nivel_9.png");
		type.set ("assets/images/nivel_9.png", AssetType.IMAGE);
		path.set ("assets/images/op1_misil.png", "assets/images/op1_misil.png");
		type.set ("assets/images/op1_misil.png", AssetType.IMAGE);
		...
		type.set ("assets/images/private3-8.png", AssetType.IMAGE);
		path.set ("assets/images/prueva2.png", "assets/images/prueva2.png");
		type.set ("assets/images/prueva2.png", AssetType.IMAGE);
		path.set ("assets/images/pruevaNivel3-8.png", "assets/images/pruevaNivel3-8.png");
		type.set ("assets/images/pruevaNivel3-8.png", AssetType.IMAGE);
		path.set ("assets/images/tanque.png", "assets/images/tanque.png");
		type.set ("assets/images/tanque.png", AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/balaSoldado.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/balaTanque.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/fondo5.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/fondo_1_desierto.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Fondo_Nivel2.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/fondo_nivel4.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Fondo_nivel7.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/images-go-here.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/Intento_Nivel5.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/jugadorYendose.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Municion.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/nivel6_op2.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/nivel_6_op1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/nivel_9.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/op1_misil.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/private3-8.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/prueva2.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/pruevaNivel3-8.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tanque.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/torreta_jugador_op2.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/music/armaSinBalas.wav";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/music/disparoJugador.mp3";
		path.set (id, id);
		type.set (id, AssetType.MUSIC);
		id = "assets/music/DisparoJugadorAnda.wav";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/music/EfectoTriggered.wav";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/music/Metallica-FadeToBlackMusic_Video.wav";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/music/music-goes-here.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/music/Opcion1-jugador_Muere.wav";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/music/sonidoDisparoTanque.wav";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
