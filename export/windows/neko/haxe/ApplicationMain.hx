...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Theo leyenda", "Tp-final-DesarrollodevideoJuegos1", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Tp-final-Desarrollo_de_videoJuegos1";
		#end
		...
		flash.Lib.create (function () {
			...
			"Tp-final-Desarrollo_de_videoJuegos1",
			null
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Tp-final-Desarrollo_de_videoJuegos1", null, { width: 640, height: 480 });
