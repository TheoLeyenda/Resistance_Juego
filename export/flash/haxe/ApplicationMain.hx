...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/Alto_jugge_op1.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/balaOpcion_1.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/opcion_1_torreta.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/opcion_3_Jugador.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/opcion_4_Jugador.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/opcion_soldado_1.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/opcion_zombie_1.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/torreta_jugador_op2.png");
		types.push (lime.Assets.AssetType.IMAGE);
	...
	public static function main () {
		...
		config = {
			...
			file: "Tp-final-DesarrollodevideoJuegos1",
			fps: 60,
			name: "Tp-final-Desarrollo_de_videoJuegos1",
			orientation: "",
			...
			windows: [
				
				{
					...
					resizable: true,
					stencilBuffer: true,
					title: "Tp-final-Desarrollo_de_videoJuegos1",
					vsync: true,
					width: 640,
					x: null,
					y: null
